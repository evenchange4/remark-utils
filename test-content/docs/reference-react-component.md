...
The only method you _must_ define in a `React.Component` subclass is called [`render()`](#render). All the other methods described on this page are optional.
...
For more details, see [_Error Handling in React 16_](/blog/2017/07/26/error-handling-in-react-16.html).
