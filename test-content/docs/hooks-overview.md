...
Finally, don't miss the [introduction page](/docs/hooks-intro.html) which explains _why_ we're adding Hooks and how we'll start using them side by side with classes -- without rewriting our apps.
